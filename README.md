...
Play the game in your web browser: [Zombie Pandemic Recreated](https://zombie-pandemic-recreated.vercel.app/)

> [!NOTE]
> As of now, the game is still a work in progress and is not playable yet. See [project's roadmap](#projects-roadmap) for details.
...
- [Bun](https://bun.sh/) (JavaScript runtime and server-sided code)
- [Vercel](https://vercel.com/home) (for hosting the app)
